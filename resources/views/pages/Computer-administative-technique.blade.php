...
@section('content')
	...
	{{--  مبنى قسم الحاسب الالي والتقنية الادارية  --}}
<!-- Divider -->
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6 position-relative">
				<img class="rounded" src="{{ asset('assets/images/bulding/B.jpg') }}" alt="Image">
				<!-- Card format icon -->
        ...
        <a href="#" class="badge bg-primary-soft text-primary mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Review</a>
				...
				<h1 class="display-6">مبنى قسم الحاسب الالي والتقنية الادارية</h1>
