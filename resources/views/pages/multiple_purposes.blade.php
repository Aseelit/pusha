	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6 position-relative">
				<img class="rounded" src="{{ asset('assets/images/bulding/H.jpg') }}" alt="Image">
				<!-- Card format icon -->
				<h5 class="p-3 pe-4 position-absolute top-0 end-0">
					<span class="badge bg-success text-white fw-bold rounded-pill">B</span>
				</h5>
			</div>
			<!-- Content -->
			<div class="col-md-6 mt-4 mt-md-0">
        <a href="#" class="badge bg-primary-soft text-primary mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>كلية بيشة</a>
				<h1 class="display-6">مبنى الاغراض المتعددة</h1>
	...
	<div class="container position-relative" data-sticky-container>
		<div class="row">
			...
			<div class="col-md-10 col-lg-8 mb-5">
				...
				<div class="text-center h5 mb-4">الدور الثاني</div>
