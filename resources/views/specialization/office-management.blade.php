		...
		<div class="row align-items-center">
			...
			<div class="col-md-6 position-relative">
				...
				<h5 class="p-3 pe-4 position-absolute top-0 end-0">
					<span class="badge bg-success text-white fw-bold rounded-pill">تخصص ادارة مكتبية</span>
				</h5>
			</div>
			<!-- Content -->
			<div class="col-md-6 mt-4 mt-md-0">
        <a href="#" class="badge bg-primary-soft text-primary mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>التقنية الادارية</a>
				<h1 class="display-6">تخصص ادارة مكتبية</h1>
